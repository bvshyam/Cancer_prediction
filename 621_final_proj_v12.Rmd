...
### Predictor transformations and removal of correlated variables
...
<li> Linear models: Logistic regression, Probit regression </li>
...
### Logistic regression (reduced model without hightly correlated predictors)
